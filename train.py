...
from src.model_fns import model_fn
from src.input_fns import vae_input_fn
from configs.config import retrieve_hparams
...
def main():
    ...
    params = retrieve_hparams(args.model)
    ...
    config = tpu_config.RunConfig(
        ...
        tpu_config=tpu_config.TPUConfig(
            ...
            experimental_host_call_every_n_steps=params["iters_per_host_call"],
